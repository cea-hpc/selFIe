...
params_in selfie_input;
params_out selfie_output;
...
__attribute__((constructor)) void selfie_init(void)
{
  ...
  // Initialize params
  selfie_alloc_params_in(&selfie_input);
  selfie_alloc_params_out(&selfie_output);

  // Read configuration file
  selfie_read_config_file(&selfie_input);

  // Read runtime environment variables
  selfie_read_env_vars(&selfie_input);

  // Check exclude commands
  selfie_check_exclude(&selfie_input);
...
__attribute__((destructor)) void selfie_finalize(void)
{
  ...
  while (selfie_plugins[i] != NULL)
  {
    (selfie_plugins[i]->finalize)(&selfie_input, &selfie_output);
    i++;
  }

  // Write log
  selfie_write_log(&selfie_input, &selfie_output);

  // Write output
  selfie_write_output(&selfie_input, &selfie_output);
  ...
  // Release params
  selfie_free_params_in(&selfie_input);
  selfie_free_params_out(&selfie_output);
}
