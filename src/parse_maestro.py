...
"""
Script to generate MAESTRO functions
"""
...
PROGRAM_HELP = """
{0} is a tool generate selFIe MAESTRO function include file
...
def main():
    ...
    out = header("maestro", len(d['name']), func_list(d), def_func_list(plugin_name="maestro",d=d))
